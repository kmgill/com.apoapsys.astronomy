...
public class FastTrig
{
	 ...
	 * href="http://www.beyond3d.com/content/articles/8/"
	 * >http://www.beyond3d.com/content/articles/8/</a>
	 * 
	 * @param x
	 *            Positive value to estimate inverse of square root of
	...
	public static double atan2(double y, double x)
	{
		...
		// We deliberately force truncation by adding floating-point numbers
		// whose
		// exponents differ greatly. The FPU will right-shift y to match
		// exponents,
		// dropping all but the first 9 significant bits, which become the 9
		// LSBs
		...
		// Find phi (a first approximation of theta) from the LUT
		double phi = ASIN_TAB[ind];
		double cphi = COS_TAB[ind]; // cos(phi)

		// sin(phi) == ind / 256.0
		// Note that sphi is truncated, hence not identical to y.
	...
	private static final double FRAC_BIAS = Double
			.longBitsToDouble((0x433L - FRAC_EXP) << 52);
